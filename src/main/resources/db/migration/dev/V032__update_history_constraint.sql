...
ALTER TABLE if exists history DROP CONSTRAINT if exists history_entity_type_check;

ALTER TABLE if exists history ADD CONSTRAINT history_entity_type_check
