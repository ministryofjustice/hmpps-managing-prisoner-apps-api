...
import uk.gov.justice.digital.hmpps.managingprisonerappsapi.dto.PrisonerDto
...
class PrisonerSearchClient(
  ...
  fun getPrisonerById(prisonerId: String): PrisonerDto = getPrisonerByIdAsMono(prisonerId)
    ...
    .blockOptional().orElseThrow { NotFoundException("Prisoner with id - $prisonerId not found on prisoner search") }
