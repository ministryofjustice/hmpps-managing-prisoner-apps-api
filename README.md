...
[![repo standards badge](https://img.shields.io/badge/endpoint.svg?&style=flat&logo=github&url=https%3A%2F%2Foperations-engineering-reports.cloud-platform.service.justice.gov.uk%2Fapi%2Fv1%2Fcompliant_public_repositories%2Fhmpps-managing-prisoner-apps-api)](https://operations-engineering-reports.cloud-platform.service.justice.gov.uk/public-report/hmpps-managing-prisoner-apps-api "Link to report")
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-managing-prisoner-apps-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://hmpps-managing-prisoner-apps-api-dev.hmpps.service.justice.gov.uk/webjars/swagger-ui/index.html?configUrl=/v3/api-docs)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-managing-prisoner-apps-api/security/policy).
...
## Renaming from HMPPS Managing Prisoner Apps Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-managing-prisoner-apps-api=0
```
